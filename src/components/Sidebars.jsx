...
// //       icon: MdDashboard,
// //     },
// //     { key: "user", name: "User List", path: "/user", icon: FaClipboardList },
...
//       path: "/dashboard",
//       icon: MdDashboard,
//       permission: "dashboard", // matches user.dashboard → but your data uses "Dashboard" (capital)
//     },
//     {
//       key: "user",
//       name: "User List",
...
//       path: "/product-management",
//       icon: FaBoxOpen,
//       permission: "productmanagement", // note: camelCase vs flat lowercase
//     },
//     {
//       key: "clients",
//       name: "Clients",
...
//   path: "/orders",
//   icon: FaShoppingBag,
//   permission: "orders", // assuming you want to control this later
// },
//     {
//       key: "termsAndConditions",
//       name: "Terms & Conditions",
...
const Sidebars = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      name: "User List",
      path: "/user",
      icon: FaUsers, // Changed from FaClipboardList to FaUsers
      permission: "user",
    },
    {
      key: "master",
